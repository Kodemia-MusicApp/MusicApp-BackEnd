...
const getAll = async () => {
  ...
  const create = async (name,lastname,secondlastname,password,email,phone,paymentmethod,estado ) => {
    //const hash = await encrypt.hashPassword(password)
    const cliente  = new Cliente({name,lastname,secondlastname,password,email,phone,paymentmethod,estado});
